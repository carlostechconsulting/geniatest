// <copyright file="ReportController.cs" company="LPC Latina">
...
public partial class ReportController : Controller
{
	...
	public async Task Proxy()
	{
		...
		var requestedUrl = Request.GetDisplayUrl()
			.Replace(urlToReplace, string.Empty, StringComparison.InvariantCultureIgnoreCase);
	...
	private static async Task WriteResponse(HttpRequest currentReqest, string url,
	...
	private async Task<HttpResponseMessage> ForwardRequest(HttpClient httpClient, HttpRequest currentReqest,
		string url)
	{
